...
namespace XCharts.Runtime
{
    public static class SerieLabelPool
    {
        ...
        private static Dictionary<EntityId, bool> m_ReleaseDic = new(1000);
            ...
            float iconWidth, float iconHeight, ThemeStyle theme)
        {
            ...
            else
            {
                ...
                m_ReleaseDic.Remove(element.GetEntityId());
                element.name = name;
        ...
        public static void Release(GameObject element)
        {
            ...
            if (!m_ReleaseDic.ContainsKey(element.GetEntityId()))
            {
                m_Stack.Push(element);
                m_ReleaseDic.Add(element.GetEntityId(), true);
            }
        }
